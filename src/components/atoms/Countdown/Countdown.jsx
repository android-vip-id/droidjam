	...
	return (
		<ReactCountdown
			...
			renderer={({ days, hours, minutes, seconds }) => (
				<div className="grid grid-cols-2 xs:grid-cols-4 w-full max-w-screen-lg mx-auto gap-4">
					<div className=" p-3 space-y-1 text-center text-white bg-gray-500 border border-gray-700 border-dashed rounded-md md:p-5 bg-opacity-20">
